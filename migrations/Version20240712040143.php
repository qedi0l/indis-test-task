 ...
 */
final class Version20240712040143 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE author (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, surname VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, books_from_publisher_id INT DEFAULT NULL, publisher_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, release_date VARCHAR(255) DEFAULT NULL, INDEX IDX_CBE5A33139B02C39 (books_from_publisher_id), INDEX IDX_CBE5A33140C86FCE (publisher_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE book ADD CONSTRAINT FK_CBE5A33139B02C39 FOREIGN KEY (books_from_publisher_id) REFERENCES publisher (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP FOREIGN KEY FK_CBE5A33139B02C39');
